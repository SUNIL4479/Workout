...
const styles = StyleSheet.create({
  ...
  stage: { borderRadius: 28, overflow: "hidden", backgroundColor: colors.surface2 },
  stageGif: { width: "100%", height: 260, backgroundColor: colors.surface2 },
  restStage: { alignItems: "center", justifyContent: "center", backgroundColor: colors.surface2 },
  actionArea: { alignItems: "center", backgroundColor: colors.surface, paddingVertical: 20 },
  counterBtn: {
    width: 56,
    height: 56,
    borderRadius: 28,
